...
(function ($) {
        ...
        return this.each(function () {
            ...
            if (!data) {
                ...
                if (options.selectText.length > 0 && options.defaultSelectedIndex == null) {
                    ...
                    : 0;
                    selectIndex(obj, index, options.onLoad);
                }
                ...
                obj.find('.dd-select').on('click.ddslick', function () {
                    open(obj);
                    if (typeof pluginData.settings.onClick == 'function') {
                        pluginData.settings.onClick.call(this, pluginData);
                    }
                });
    ...
    function selectIndex(obj, index, selectOnFunctio) {

        var selectOnFunctio = typeof selectOnFunctio !== 'undefined' ? selectOnFunctio : true;
        //Get plugin data
